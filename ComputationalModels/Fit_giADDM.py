...
# paramstofit = {'wself':1,'wother':1,'wfair':1,'bound':1,'collapse':1,'stbias':1, 'genbias':0, 'theta':1, 
#     'dwself':1,'dwother':1,'dwfair':1,'dbound':1,'dcollapse':1,'dstbias':1, 'dgenbias':0, 'dtheta':1}


###only toggle change params here to determine if only estimating 1 parameter value across both conditions
### e.g. if 'theta': 1 and 'dtheta':0, model will estimate one theta parameter for high and low time pressure.
# paramstofit = {'wself':1,'wother':1,'wfair':1,'bound':1,'collapse':1,'stbias':1, 'genbias':1, 'theta':1, 
#     'dwself':1,'dwother':1,'dwfair':1,'dbound':1,'dcollapse':1,'dstbias':1, 'dgenbias':1, 'dtheta':0}
...
##Fix value of model params across both conditions: wself, wother, wfair, bound, collapse, stbias, genbias, theta, 
